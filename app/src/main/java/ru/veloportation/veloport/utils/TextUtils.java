...
public abstract class TextUtils {
	 ...
	 * ic_1 - local part  (usually up to 64 symbols)
	 * ic_3 - domain part (usually up to 256 symbols)
	 */
	 ...
	 *
	 * Useful capturing group indices:
	 * ic_1 - Country code (CC ITU-T) 	(usually ic_1 to ic_3 digits)
	 * ic_2 - National number			(usually 7 to 14 digits)
	 */
